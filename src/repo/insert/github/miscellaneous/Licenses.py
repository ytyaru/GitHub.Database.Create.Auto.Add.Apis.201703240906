...
import repo.insert.github.common.HttpHeader
import repo.insert.github.common.HttpResponser
class Licenses:
    def __init__(self, data):
        self.data = data
        self.header = repo.insert.github.common.HttpHeader.HttpHeader(self.data)
        self.responser = repo.insert.github.common.HttpResponser.HttpResponser()
