...
import repo.insert.github.common.Pagenation
class Languages:
    def __init__(self, db_path_repo, req_param):
        self.req = req_param
        self.db_path_repo = db_path_repo
        self.db_repo = dataset.connect('sqlite:///' + db_path_repo)
        self.api = repo.insert.github.repositories.Repositories.Repositories(req_param)
        self.page = repo.insert.github.common.Pagenation.Pagenation(req_param)
