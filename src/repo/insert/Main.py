...
import os.path
import getpass
import repo.insert.Data
import repo.insert.command.repositories.Inserter
import repo.insert.github.common.RequestParam
import repo.insert.github.repositories.Languages
class Main:
    def __init__(self, user_name, path_db_account, path_db_repo, path_db_license, path_db_api):
        self.data = repo.insert.Data.Data(user_name, path_db_account, path_db_repo, path_db_license)
        self.request_param = repo.insert.github.common.RequestParam.RequestParam(path_db_account, path_db_api, user_name)
        self.inserter = repo.insert.command.repositories.Inserter.Inserter(self.data)
