...
import repo.insert.github.miscellaneous.Licenses
import repo.insert.github.repositories.Repositories
class Inserter:
    def __init__(self, data):
        self.data = data
        self.license = repo.insert.github.miscellaneous.Licenses.Licenses(self.data)
    ...
    def Insert(self, request_param):
        repository = repo.insert.github.repositories.Repositories.Repositories(request_param)
