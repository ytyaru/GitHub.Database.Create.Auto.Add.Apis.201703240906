...
#encoding:utf-8
import dataset
import other_repo.insert.github.api.repositories.Repositories
import time
class Languages:
    def __init__(self, db_path_repo, req_param):
        ...
        self.api = other_repo.insert.github.api.repositories.Repositories.Repositories(req_param)
        self.page = other_repo.insert.github.api.Pagenation.Pagenation(req_param)
