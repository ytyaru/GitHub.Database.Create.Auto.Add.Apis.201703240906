...
import json
import datetime
import other_repo.insert.github.common.HttpHeader
import other_repo.insert.github.common.HttpResponser
class Requester:
    def __init__(self, data):
        self.data = data
        self.header = other_repo.insert.github.common.HttpHeader.HttpHeader(self.data)
        self.responser = other_repo.insert.github.common.HttpResponser.HttpResponser(self.data)
